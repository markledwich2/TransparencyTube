...
export const Spinner = ({ size, style }: { size: string } & StyleProps) => <SvgStyle width={size} height={size} style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
    <circle cx="38.8072" cy="50" fill='var(--bg1)' r="22">
    ...
    <circle cx="61.1928" cy="50" fill='var(--bg2)' r="22">
    ...
    <circle cx="38.8072" cy="50" fill='var(--bg3)' r="22">
        <animate attributeName="cx" repeatCount="indefinite" dur="0.7194244604316546s" keyTimes="0;0.5;1" values="28;72;28" begin="-0.3597122302158273s"></animate>
