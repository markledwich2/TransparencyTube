...
const IndexPage = () => <Layout>
  ...
  <PurposeDiv>
    <div style={{ maxWidth: '50em', margin: 'auto' }}>
      ...
      <p className="subtle">Note - Channel classification is based on video content, not the identity of the channel creator. There is human judgement involved and the possibility for algorithmic inaccuracy, so please contact us if you think a channel has been misclassified or is missing.</p>
    </div>
  </PurposeDiv>
  <ChannelViewsPage />
  <Footer />
