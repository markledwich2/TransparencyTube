...
const seenIn: SeenIn[] = [
  {
    url: 'https://www.washingtonpost.com/business/2020/12/09/youtube-false-2020-election-claims/',
    title: 'YouTube removes 8,000 channels promoting false election claims.',
    publisher: 'WaPo',
    author: 'Taylor Telford',
    authorImg: 'https://www.washingtonpost.com/wp-apps/imrs.php?src=https://s3.amazonaws.com/arc-authors/washpost/9c9653ff-317e-4d02-8eae-c644b0e1eb4e.png&w=90&h=90',
    date: '2020-12-10'
  },
  {
