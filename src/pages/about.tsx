...
Transparency.tube fills this data vacuum to help journalists, researchers, and the curious better understand YouTube’s political landscape. Our platform has created an interactive visualization of 8,162 channels that discuss political or cultural issues. This includes views and estimated watch time data for the approximately 9.3M videos posted by these channels. Along with classifying each channel’s political leaning as left, center, or right, we go a step further and assign one or more of 14 different calibrated tags to each channel. This enables a view into a number of the niche communities that YouTube has fostered.
